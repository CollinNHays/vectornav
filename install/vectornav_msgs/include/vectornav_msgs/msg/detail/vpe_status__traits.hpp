  ...
  std::ostream & out, size_t indentation = 0)
{
  // member: attitude_quality
  {
    ...
    value_to_yaml(msg.attitude_quality, out);
    out << "\n";
  }
  ...
  // member: gyro_saturation
  {
    ...
    out << "gyro_saturation: ";
    value_to_yaml(msg.gyro_saturation, out);
    out << "\n";
  }
  ...
  // member: gyro_saturation_recovery
  {
    ...
    value_to_yaml(msg.gyro_saturation_recovery, out);
    out << "\n";
  }
  ...
  // member: mag_disturbance
  {
    ...
    out << "mag_disturbance: ";
    value_to_yaml(msg.mag_disturbance, out);
    out << "\n";
  }
  ...
  // member: mag_saturation
  {
    ...
    out << "mag_saturation: ";
    value_to_yaml(msg.mag_saturation, out);
    out << "\n";
  }
  ...
  // member: acc_disturbance
  {
    ...
    out << "acc_disturbance: ";
    value_to_yaml(msg.acc_disturbance, out);
    out << "\n";
  }
  ...
  // member: acc_saturation
  {
    ...
    out << "acc_saturation: ";
    value_to_yaml(msg.acc_saturation, out);
    out << "\n";
  }
  ...
  // member: known_mag_disturbance
  {
    ...
    value_to_yaml(msg.known_mag_disturbance, out);
    out << "\n";
  }
  ...
  // member: known_accel_disturbance
  {
    ...
    value_to_yaml(msg.known_accel_disturbance, out);
    out << "\n";
  }
